        ...
        try:
            ...
            for group_id, group_name in grupos:
                try:
                    ...
                    logger.warning(f"[{nombre_sesion}] ⚠️ Fallo en {group_name} ({fallos_consecutivos}/5): {e}")
                    ...
                    try:
                        ...
                        if fallos_consecutivos >= 5:
                            logger.info(f"[{nombre_sesion}] ⏰ 5 fallos consecutivos. Esperando {cooldown_minutes}min...")
                            await asyncio.sleep(cooldown_minutes * 60)
                            fallos_consecutivos = 0
